...
class ProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'tipo' => 'required|in:urbanas,deportivas,botas,sandalias',
            'descripcion' => 'nullable|string',
            'cierre' => 'required|in:Cordones,Velcro,Cierre rapido,Zipper,Slip-on',
            'altura_suela' => 'required|in:baja,media,alta',
