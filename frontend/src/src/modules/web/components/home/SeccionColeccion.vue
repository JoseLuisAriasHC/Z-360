<script setup lang="ts">
    ...
    import card_hombre from '@/assets/img/card/card_hombre.webp';
    import card_mujer from '@/assets/img/card/card_mujer.webp';
    import card_unisex from '@/assets/img/card/card_unisex.webp';
...
<template>
    <div class="grid grid-cols-12 gap-8 w-full px-4 sm:px-10 xl:py-16 xl:px-60">
        <div class="col-span-12">
            <h2 class="text-4xl font-extrabold text-gray-800 text-center mt-12 mb-12 pb-3">Más que una Tienda, un Estilo de Vida</h2>
        </div>

        <div v-for="collection in collections" :key="collection.title" class="col-span-12 md:col-span-6 lg:col-span-4">
            <CollectionCard
